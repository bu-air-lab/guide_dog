python3 legged_gym/scripts/train.py --task=guide_dog --trial_name=no_estimator1 --seed=1 --headless
python3 legged_gym/scripts/train.py --task=guide_dog --trial_name=no_estimator2 --seed=2 --headless
