...
ppo_runner = OnPolicyRunner(BlankEnv(use_force_estimator=True, train_vel_only=True), train_cfg_dict)
...
for y_force in y_force_strengths:
	...
	for seed in range(1,6):
		...
		ppo_runner.load("/home/david/Desktop/guide_dog/logs/guide_dog/estimator" + str(seed) + "_vel_only/model_1500.pt")
